...
/// <summary>
/// Self-contained read: the non-deleted categories ordered by name, for the admin
/// category list. Owned by <see cref="AdminGetCategoriesHandler"/>; the not-deleted
...
public sealed class AdminGetCategoriesQuery
{
    ...
    public AdminGetCategoriesQuery(IReadDbContext readDbContext)
    {
