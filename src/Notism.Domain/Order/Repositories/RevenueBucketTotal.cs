...
/// <para><see cref="Revenue"/> sums <c>TotalAmount</c> (full <c>numeric</c>
/// precision) of Paid orders whose <c>PaidAt</c> falls in that range.</para>
/// Only buckets that contain Paid orders are produced; the consuming handler
/// owns zero-filling absent indices into a dense ordered series.
/// </summary>
